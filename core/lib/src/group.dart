...
class Group extends ContainerNode {
  Group([Map<String, dynamic> properties = const {}]) : super(properties);

  @override
  Group clone([Map<String, dynamic> propertiesOverride = const {}]) {
    var clone = new Group(cloneProperties(propertiesOverride));
...
//      new Group(cloneProperty(propOverride));
...
//    if (getProperty('reflectable', true)) {
